                        ...
                        <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                            <div class="owl-thumbs d-flex flex-row flex-sm-column" data-slider-id="1">
                                @foreach($product->media as $media)
                                    ...
                                    <div
                                        class="owl-thumb-item flex-fill mb-2 {{!$loop->last ? 'mr-2 mr-sm-0' : null }}">
                        ...
                        @if($product->reviews_avg_rating != '')
                            @for($i = 0; $i<5; $i++)
                                ...
                                <li class="list-inline-item m-0">
                                    <i class="{{ round($product->reviews_avg_rating) >= $i ? 'fas' : 'far'}} fa-star small text-warning"></i>
                                </li>
                                ...
                                @forelse($product->reviews as $review)
                                    <div class="media {{!$loop->last ? 'mb-3' : null}}">
                                        <img class="rounded-circle"
                                             src="{{ asset(!empty($review->user->user_image) ? 'assets/users/'. $review->user->user_image : 'assets/users/avatar.svg') }}"
                                             alt=""
                                             width="50">
                                            ...
                                            <ul class="list-inline mb-1 text-xs">
                                                @if($review->rating != '')
                                                    @for($i = 0; $i<5; $i++)
                                                        ...
                                                        <li class="list-inline-item m-0">
                                                            <i class="{{ round($review->rating) >= $i ? 'fas' : 'far'}} fa-star small text-warning"></i>
                                                        </li>
