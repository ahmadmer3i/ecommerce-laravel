    ...
    <section class="pt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4"><a class="category-item" href="{{ route('frontend.shop') }}">
                    <img class="img-fluid" src="{{ asset('frontend/img/cat-img-4.jpg') }}" alt=""><strong
                        class="category-item-title">Electronics</strong>
                </a>
            </div>
        </div>
    </section>
                    ...
                    <div class="position-relative mb-3">
                        ...
                        <div class="product-overlay">
                            <ul class="mb-0 list-inline">
                                ...
                                <li class="list-inline-item m-0 p-0">
                                    <a class="btn btn-sm btn-dark" href="{{ route('frontend.cart') }}">Add to cart</a>
                                </li>
                    ...
                    <div class="position-relative mb-3">
                        ...
                        <div class="product-overlay">
                            <ul class="mb-0 list-inline">
                                ...
                                <li class="list-inline-item mr-0">
                                    <a class="btn btn-sm btn-outline-dark"
                                       href="#productView" data-toggle="modal">
                                        <i class="fas fa-expand"></i>
                                    </a>
                                </li>
                            </ul>
                ...
                <div class="col-lg-6">
                    <form action="#">
                        <div class="input-group flex-column flex-sm-row mb-3">
                            <input class="form-control form-control-lg py-3"
                                   type="email"
