                ...
                @if($menu->appearedChildren && count($menu->appearedChildren) > 0 !== null)
                    <div id="collapse_{{$menu->route}}"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            @foreach($menu->appearedChildren as $submenu)
                                <a class="collapse-item {{ getParentOf($current_page) != null && (int)(getParentIdOf($current_page) + 1) == $submenu->id ? 'active' : null }}"
