    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.product_categories.update', $productCategory->id) }}" method="post"
                    ...
                    <div class="col-3">
                        ...
                        <select name="parent_id" id="parent_id" class="form-control form-select">
                            ...
                            @forelse($main_categories as $main_category)
                                <option
                                    value="{{ $main_category->id }}" {{ old('patent_id', $productCategory->parent_id) == $main_category->id ? 'selected' : null  }}>{{ $main_category->name }}</option>
                            @empty
                            @endforelse
                        </select>
                ...
                <div class="row pt-4">
                    <div class="col-12">
                        <label for="category-image">Cover</label>
                        <br>
                        <div class="file-loading">
                            <input type="file" name="cover" id="category-image" class="file-input-new">
