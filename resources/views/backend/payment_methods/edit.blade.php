                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="code" value="{{ old('code', $payment_method->code) }}"
                                   class="form-control">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select name="sandbox" class="form-control">
                                <option
                                    value="1" {{ old('sandbox', $payment_method->sandbox) == '1' ? 'selected' : null }}>
                                    Sandbox
                                </option>
                                <option
                                    value="0" {{ old('sandbox', $payment_method->sandbox) == '0' ? 'selected' : null }}>
                                    Live
                                </option>
                            </select>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option
                                    value="1" {{ old('status', $payment_method->status) == '1' ? 'selected' : null }}>
                                    Active
                                </option>
                                <option
                                    value="0" {{ old('status', $payment_method->status) == '0' ? 'selected' : null }}>
                                    Inactive
                                </option>
                            </select>
