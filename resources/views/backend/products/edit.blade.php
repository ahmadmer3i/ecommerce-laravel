            ...
            <form action="{{ route('admin.products.update', $product->id) }}" method="post"
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <select name="product_category_id" id="product_category_id" class="form-control form-select">
                            <option value="">---</option>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <input name="price" id="price" class="form-control" value="{{ old('price', $product->price) }}">
                        @error('price')<span class="text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="col-4">
                        <label for="featured">Featured</label>
                        <select name="featured" class="form-control form-select" id="featured">
            ...
            $("#product-images").fileinput({
                ...
                initialPreviewConfig: [
                        ...
                        @foreach($product->media as $media)
                    {
                        ...
                        siz: '{{ $media->file_size }}',
                        width: "120px",
                        url: "{{ route('admin.products.remove_image', ['media_id'=> $media->id, 'product_id'=>$product->id, '_token'=>csrf_token()])}}",
                        key: {{ $media->id }}
                    },
                    @endforeach
                    @endif
