                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="number" id="use_times" name="use_times" value="{{ old('use_times') }}"
                                   class="form-control"/>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="expire_date" name="expire_date" value="{{ old('expire_date') }}"
                                   class="form-control"/>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="number" id="greater_than" name="greater_than" value="{{ old('greater_than') }}"
                                   class="form-control"/>
