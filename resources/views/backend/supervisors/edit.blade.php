...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.supervisors.update', $supervisor->id) }}"
                  method="post"
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email', $supervisor->email) }}"
                                   class="form-control"/>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <select name="permissions[]" class="form-control form-select select-multiple-tags"
                                    id="permissions"
                                    multiple="multiple">
                ...
                <div class="row pt-4">
                    <div class="col-12">
                        <label for="supervisor_image">User Image</label>
                        <br>
                        <div class="file-loading">
                            <input type="file" id="supervisor_image" name="user_image" class="file-input-new">
