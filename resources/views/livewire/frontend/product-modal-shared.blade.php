                        ...
                        <div class="col-lg-6">
                            ...
                            <div wire:ignore class="p-5 my-md-4">
                                    ...
                                    @if($productModal->reviews_avg_rating != '')
                                        @for($i = 0; $i<5; $i++)
                                            ...
                                            <li class="list-inline-item m-0">
                                                <i class="{{ round($productModal->reviews_avg_rating) >= $i ? 'fas' : 'far'}} fa-star small text-warning"></i>
                                            </li>
                                ...
                                <div class="row align-items-stretch mb-4">
                                    ...
                                    <div wire:click="addToCart" class="col-sm-5 pl-sm-0"><a
                                            class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0 text-white"
                                        >Add to cart</a></div>
                                </div>
                                <a class="btn btn-link text-dark p-0" wire:click="addToWishlist">
