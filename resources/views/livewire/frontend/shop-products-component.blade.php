        ...
        <div class="container p-0">
            <div class="row">
                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    ...
                    @endforeach<h5 class="text-uppercase mb-4">Tags</h5>

                    <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                        @forelse($shop_tags_menu as $shop_tag)
                            <li class="mb-2">
                                <a class="reset-anchor"
                                   href="{{ route('frontend.shop_tag', $shop_tag->slug) }}">
                                    {{ $shop_tag->name }}
                                </a>
                            </li>
                        @empty
                ...
                <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                        ...
                        <div class="col-lg-6">
                            <ul class="list-inline d-flex align-items-center justify-content-lg-end mb-0">
                                ...
                                <li class="list-inline-item" wire:ignore>
                                    <select class="selectpicker ml-auto" wire:model="sortingBy" name="sorting"
                                            data-width="200"
                    ...
                    <div class="row">
                        ...
                        @forelse($products as $product)
                            <div class="col-4" id="product-container-area">
                                <div class="product text-center">
                                            ...
                                            <ul class="mb-0 list-inline">
                                                ...
                                                <li class="list-inline-item m-0 p-0">
                                                    <a wire:click.prevent="addToCart('{{ $product->id }}')"
                                                       class="btn btn-sm btn-dark" href="javascript:void(0)">
                                                        Add to cart
                                                    </a>
                                                </li>
                                    ...
                                    <h6><a class="reset-anchor" href="{{ route('frontend.shop', $product->slug) }}">
                                            {{ $product->name }}
                                        </a></h6>
...
@section('script')
    <script>
        ...
        document.getElementById('two-items').onclick = function () {
