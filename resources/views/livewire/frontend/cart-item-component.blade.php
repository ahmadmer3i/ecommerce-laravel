<tr x-data="{ show: true }" x-show="show">
    ...
    <td class="align-middle border-0">
        <div class="border d-flex align-items-center justify-content-between px-3">
            ...
            <div class="quantity">
                <button wire:click.prevent="decreaseQty('{{ $cartItem->rowId }}')" class="p-0"><i
                ...
                {{--<input class="form-control form-control-sm border-0 shadow-0 p-0"
                       type="text"
                />--}}
                <button wire:click="increaseQty('{{ $cartItem->rowId }}')" class="p-0"><i
    ...
    <td class="align-middle border-0">
        <p class="mb-0 small">${{ $cartItem->price * $cartItem->qty}}</p>
    </td>
    <td class="align-middle border-0">
