            ...
            <table class="table">
                ...
                @forelse($orders as $order)
                    <tr wire:key="{{ $order->id }}">
                        ...
                        <td class="text-right">
                            <button type="button" x-on:click="showOrder=true"
            ...
            <div class="table-responsive mb-4">
                <table class="table">
                    ...
                    <tr>
                        ...
                        {{--                        <th class="border-0" scope="col"><strong class="text-small text-uppercase">Days</strong>--}}
                        {{--                        </th>--}}
                        ...
                        <tr>
                            ...
                            <td>
                                @if($loop->last
                                    ...
                                    <button wire:click="requestReturnOrder('{{ $order->id }}')"
                                            class="btn btn-link text-right">You can return order
                                        in {{ 5 - $transaction->created_at->diffInDays() }} days
                                    </button>
                                @endif
                            </td>
                        </tr>
