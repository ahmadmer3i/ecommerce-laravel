...
//        $input[ 'status' ] = $request->status;
    ...
    public function show(UserAddress $user_address)
    {
        ...
        return view('backend.customer_addresses.show', compact('user_address'));
    }
    ...
    public function destroy(UserAddress $customer_address)
    {
        ...
        return redirect()->route('admin.customer_addresses.index')->with([ 'message' => 'Deleted Successfully',
            'alert-type' => 'success' ]);
    }
}
