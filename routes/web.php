...
Route::group([ 'prefix' => 'admin', 'as' => 'admin.' ], function () {
    ...
    Route::group([ 'middleware' => [ 'roles', 'role:admin|supervisor' ] ], function () {
        ...
        Route::post('/product_categories/remove_image', [ Backend\ProductCategoriesController::class, 'remove_image' ])->name('product_categories.remove_image');
        Route::resource('product_categories', Backend\ProductCategoriesController::class);
        Route::post('/products/remove_image', [ Backend\ProductController::class, 'remove_image' ])->name('products.remove_image');
        ...
        Route::post('/customers/remove_image', [ Backend\CustomerController::class, 'remove_image' ])->name('customers.remove_image');
        ...
        Route::post('/supervisors/remove_image', [ Backend\SupervisorController::class, 'remove_image' ])->name('supervisors.remove_image');
        Route::resource('supervisors', Backend\SupervisorController::class);
        Route::resource('countries', Backend\CountryController::class);
        Route::get('states/get_states', [ Backend\StateController::class, 'get_states' ])->name('states.get-states');
        Route::resource('states', Backend\StateController::class);

        Route::get('cities/get_cities', [ Backend\CityController::class, 'get_cities' ])->name('cities.get-cities');
