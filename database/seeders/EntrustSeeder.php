...
//        }
        ...
        $showCustomerAddresses = Permission::create([
        ...
        $displayCustomerAddresses = Permission::create([
        ...
        $updateCustomerAddresses = Permission::create([
        ...
        $deleteCustomerAddresses = Permission::create([
        ...
        $deleteShippingCompanies = Permission::create([
            'name' => 'delete_shipping_companies',
            'display_name' => 'Delete Shipping Company',
            'route' => 'shipping_companies',
            'module' => 'shipping_companies',
            'as' => 'shipping_companies.destroy',
            'icon' => null,
            'parent' => $manageShippingCompanies->id,
            'parent_original' => $manageShippingCompanies->id,
            'parent_show' => $manageShippingCompanies->id,
